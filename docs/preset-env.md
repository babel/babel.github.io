...
> _Please note_: when specifying the esmodules target, browsers targets will be ignored. But `browserslist`'s configuration will still work intersectly at the same time.
